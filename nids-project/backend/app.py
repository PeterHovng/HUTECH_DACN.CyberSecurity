...
try:
#   model = joblib.load(r'C:\Users\Admin\Desktop\nids-project\trained_models\random_forest_multi_class_model.pkl')
    model = joblib.load(r'C:\Users\Admin\Desktop\nids-project\trained_models\decision_tree_multi_class_model.pkl')
#   model = joblib.load(r'C:\Users\Admin\Desktop\nids-project\trained_models\xgboost_multi_class_model.pkl')
#   model = joblib.load(r'C:\Users\Admin\Desktop\nids-project\trained_models\ensemble_dt_xg_model.pkl')
    scaler = joblib.load(r'C:\Users\Admin\Desktop\nids-project\trained_models\rf_scaler_multi_class.pkl')
except FileNotFoundError as e:
    raise HTTPException(status_code=500, detail=f"Error loading model/scaler: {str(e)}")

try:
    data = pd.read_csv(r'C:\Users\Admin\Desktop\nids-project\dataset\processed_cse_cic_ids2018_multi_class_dataset.csv')
except FileNotFoundError as e:
    raise HTTPException(status_code=500, detail=f"Error loading dataset: {str(e)}")

def init_attack_db():
    conn = sqlite3.connect(r'C:\Users\Admin\Desktop\nids-project\backend\database\attacks.db')
    c = conn.cursor()
...
def init_ipaddress_db():
    conn = sqlite3.connect(r'C:\Users\Admin\Desktop\nids-project\backend\database\ipaddress.db')
    c = conn.cursor()
